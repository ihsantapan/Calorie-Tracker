...
namespace Program.UI
{
    public partial class HomeScreen : Form
    {
        ...
        private void btnSaveMeal_Click(object sender, EventArgs e)
        {
            ...
            if (usersMealsHistoryRepository.IsMealAlreadyAdded(mealID, DateTime.Now))
            {
        ...
        private void btnNextPage_Click(object sender, EventArgs e)
        {
            ...
            lblPageNumber.Text = pageNumber.ToString();
            CategoryNameLoad();
            List<Nutrition> nutritions = nutritionRepository.GetNutrionsByCategoryName(categoryName, pageNumber);
        ...
        {
            NutritionsAddToPanel(nutritionRepository.GetNutrionsByCategoryName(categoryName, pageNumber));
        }
